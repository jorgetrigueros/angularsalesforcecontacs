...
export class ForceService {
  ...
  loginURL = 'https://login.salesforce.com';  // Personal salesforce
  // loginURL = 'https://test.salesforce.com';      // sandbox salesforce
  ...
  appId = '3MVG9fTLmJ60pJ5LPJPBb9yUI8itwumlIhuDnRJZM2iAspgnghvL5fCafsThgqkSGrrArDLzI4gu6qRBpoLMn'; // Personal salesforce
  // appId = 'xxxxxxxxxxxxxxxxxxx_xxxxxxxxxxxxxxxxxxxxxxxxxxxxx_CbuDx7h9XiCCAC_a.E8fxYThHXFbInes2';    // Dribermule salesforce 
